...
Once deployed, teams need visibility into both operational and quality metrics:

![mlflow-operational-metrics](./feedback-principles_files/mlflow-operational-metrics.png)

![mlflow-assessment-metrics](./feedback-principles_files/llm-generation-metrics.png)
...
- [Optimizing LLM prompts for low latency](https://incident.io/building-with-ai/optimizing-llm-prompts#case-study-planning-grafana-dashboards-for-an-incident)
- [From Noob to Automated Evals In A Week (as a PM) w/Teresa Torres](https://www.youtube.com/watch?v=N-qAOv_PNPc)
