...
4. Design tracing and logging modules addressing the needs listed in step 3. 
...
Map out business process workflow
...
#### Design sub-agents according to expected query patterns

**1. Account & Customer Information Queries**

**Description:**  
Queries related to customer profile information, account status, subscription details
...
Should include relevant account details while maintaining privacy safeguards. May require customer verification before providing sensitive information.

**2. Billing & Payment Queries**

**Description:**  
Questions about invoices, payments, charges, billing cycles
...
- "I see a charge for $14.99 that I don't recognize. What is that?"
- "How much data did I use last month?"
- "Did my last payment go through?"

**Response Requirements:**  
Should provide detailed breakdowns of charges, explain billing terms, offer solutions for payment issues. [P1] May require calculations to explain changes between billing cycles.
...
```    
### Align LLM judge outputs with SME feedback

Conduct workshop 

Most judge builders on the market need to assume that teams a) know what to judge and b) how to collect quality data. While this is true for many customers, there are also many for whom it is not. This workshop additionally provides:
...
Can also consider doing the same for various tracing EDA tools
